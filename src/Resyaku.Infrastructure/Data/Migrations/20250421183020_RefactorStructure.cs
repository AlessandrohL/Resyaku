    ...
    public partial class RefactorStructure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingPrefId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingTimeIncrement = table.Column<int>(type: "int", nullable: false),
                    DailyOpeningTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    DailyClosingTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    MinAdvanceNoticeDays = table.Column<int>(type: "int", nullable: false),
                    MaxAdvanceNoticeDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingSettings", x => x.BookingPrefId);
                    table.CheckConstraint("CK_BookingSettings_IsSpecial", "[IsSpecial] = 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceRowGuid = table.Column<string>(type: "nchar(36)", fixedLength: true, maxLength: 36, nullable: false),
                    ActivityLogTypeId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Booking_RowGuid",
                table: "Booking",
                column: "RowGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookingSettings_IsSpecial",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_RowGuid",
                table: "Customer",
                column: "RowGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceArea_RowGuid",
                table: "ServiceArea",
                column: "RowGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Table_RowGuid",
                table: "Table",
                column: "RowGuid",
                unique: true);
